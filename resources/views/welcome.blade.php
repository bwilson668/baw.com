...
@section('main.header.class', 'app-header')

@section('main.header')
    <img class="app-graph" src="/img/template/startup-0.svg">
...
@section('content')
        ...
        <div class="container">
            <div class="row app-align-center">
                ...
                <div class="col-sm-5 hidden-xs">
                    <img class="app-iphone" src="/img/template/startup-2.jpg" style="width: 100%;">
                </div>
    ...
    <div class="block block-secondary app-high-praise p-b-0">
        <div class="container">
            <div class="row app-align-center">
                ...
                <div class="col-sm-6 col-sm-pull-5">
                    <img src="/img/template/startup-3.jpg">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="block app-ribbon p-y-lg">
        <div class="container text-center">
            <img src="/img/template/startup-4.svg">
            <img src="/img/template/startup-5.svg">
            <img src="/img/template/startup-6.svg">
            <img src="/img/template/startup-7.svg">
            <img src="/img/template/startup-8.svg">
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-sm-4 p-x m-b-lg">
                    <div class="p-x">
                        ...
                        <img class="m-b" src="/img/template/startup-15.svg">
                ...
                <div class="col-sm-4 p-x m-b-lg">
                    <div class="p-x">
                        ...
                        <img class="m-b" src="/img/template/startup-16.svg">
                ...
                <div class="col-sm-4 p-x m-b-lg">
                    <div class="p-x">
                        ...
                        <img class="m-b" src="/img/template/startup-17.svg">
